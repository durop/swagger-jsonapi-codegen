...
const getViewForSwagger2 = function (opts, type) {
  ...
  let domain =  (swagger.schemes && swagger.schemes.length > 0 && swagger.host && swagger.basePath) ? swagger.schemes[0] + '://' + swagger.host + swagger.basePath.replace(/\/+$/g, '') : ''
  if(opts.domainOverride !== false){
