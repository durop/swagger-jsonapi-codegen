...
let tsSourceCode = CodeGen.getTypescriptCode({
    ...
    swagger: swagger,
    template: {
        'class': fs.readFileSync(path.join(process.cwd(), './templates/typescript/class.mustache'), 'utf-8'),
        'method': fs.readFileSync(path.join(process.cwd(), './templates/typescript/method.mustache'), 'utf-8'),
        'type': fs.readFileSync(path.join(process.cwd(), './templates/typescript/type.mustache'), 'utf-8')
    }
});
